...
var tasks = {
  local: ["docs", "static"],
  stage: ["docs", "clean", "template", "publish"],
  live: ["docs", "clean", "template", "publish:live"]
};
...
module.exports = function(grunt) {
  ...
  grunt.registerTask("cron", "Run the build on a timer", function(interval = 2, target = "local") {
    var done = this.async();
